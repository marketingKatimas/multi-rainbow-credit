...
//The Header
const DebtConsolidationHeader = document.getElementById('DebtConsolidationHeader');
const HomeHeader = document.getElementById('HomeHeader');
const DebtConsolidationHeaderLink = document.getElementById('DebtConsolidationHeaderLink');

//Debt Consolidation
const DebtConsolidationPages = document.getElementById('DebtConsolidationPages');
const DebtConsolidationPagesDes = document.getElementById('DebtConsolidationPagesDes');
...
function updateHeader(language) {
    if (language === 'bm') {
        DebtConsolidationHeader.textContent = 'Penyatuan Hutang';
        HomeHeader.textContent = 'Laman Utama';
        DebtConsolidationHeaderLink.textContent = 'Penyatuan Hutang';
    } else {
        DebtConsolidationHeader.textContent = 'Debt Consolidation';
        HomeHeader.textContent = 'Home';
        DebtConsolidationHeaderLink.textContent = 'Debt Consolidation';
    }
}

function updateDebtConsolidation(language) {
    if (language === 'bm') {
        DebtConsolidationPages.textContent = 'Penyatuan Hutang';
        DebtConsolidationPagesDes.textContent = 'Jangan biarkan hutang berlambak membebankan anda! Urus dan kurangkan beban faedah dan kawal kewangan anda dengan khidmat penyatuan hutang kami yang berfaedah rendah.';
        ApplyNowBtn.textContent = 'Mohon Sekarang';
    } else {
        DebtConsolidationPages.textContent = 'Debt Consolidation';
        DebtConsolidationPagesDes.textContent = 'Don’t let multiple debts weigh you down! Manage and reduce your interest burden and take control of your finances with our low interest rate solution.';
