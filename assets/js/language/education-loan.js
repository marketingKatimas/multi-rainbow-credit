...
//The Header
const EducationLoanHeader = document.getElementById('EducationLoanHeader');
const HomeHeader = document.getElementById('HomeHeader');
const EducationLoanHeaderLink = document.getElementById('EducationLoanHeaderLink');

//Education Loan
const EducationLoanPages = document.getElementById('EducationLoanPages');
const EducationLoanPagesDes = document.getElementById('EducationLoanPagesDes');
...
function updateHeader(language) {
    if (language === 'bm') {
        EducationLoanHeader.textContent = 'Pembiayaan Pendidikan';
        HomeHeader.textContent = 'Laman Utama';
        EducationLoanHeaderLink.textContent = 'Pembiayaan Pendidikan';
    } else {
        EducationLoanHeader.textContent = 'Education Loan';
        HomeHeader.textContent = 'Home';
        EducationLoanHeaderLink.textContent = 'Education Loan';
    }
}

function updateEducationLoan(language) {
    if (language === 'bm') {
        EducationLoanPages.textContent = 'Pembiayaan Pendidikan';
        EducationLoanPagesDes.textContent = 'Tumpukan pada pendidikan anda tanpa beban kewangan! Pembiayaan Pendidikan kami merangkumi yuran tuisyen, buku teks & keperluan harian agar anda dapat fokus pada pembelajaran anda. Dengan pelan bayaran balik yang mesra pelajar, melanjutkan pelajaran menjadi lebih mudah.';
        ApplyNowBtn.textContent = 'Mohon Sekarang';
    } else {
        EducationLoanPages.textContent = 'Education Loan';
        EducationLoanPagesDes.textContent = 'Concentrate on your education without the financial burden. Our education loans cover your tuition fees, textbooks & living expenses, letting you focus on your studies. With favorable repayment terms, furthering your studies are now made easy!';
