...
//The Header
const PersonalLoanHeader = document.getElementById('PersonalLoanHeader');
const HomeHeader = document.getElementById('HomeHeader');
const PersonalLoanHeaderLink = document.getElementById('PersonalLoanHeaderLink');

//Personal Loan
const PersonalLoanPages = document.getElementById('PersonalLoanPages');
const PersonalLoanPagesDes = document.getElementById('PersonalLoanPagesDes');
...
function updateHeader(language) {
    if (language === 'bm') {
        PersonalLoanHeader.textContent = 'Pembiayaan Peribadi';
        HomeHeader.textContent = 'Laman Utama';
        PersonalLoanHeaderLink.textContent = 'Pembiayaan Peribadi';
    } else {
        PersonalLoanHeader.textContent = 'Personal Loan';
        HomeHeader.textContent = 'Home';
        PersonalLoanHeaderLink.textContent = 'Personal Loan';
    }
}

function updatePersonalLoan(language) {
    if (language === 'bm') {
        PersonalLoanPages.textContent = 'Pembiayaan Peribadi';
        PersonalLoanPagesDes.textContent = 'Dengan pembiayaan peribadi kami, anda akan menerima pelan direka khas berdasarkan kelayakan kredit dan pendapatan anda, agar bayaran balik anda mengikut bajet tanpa membebankan kewangan anda.';
        ApplyNowBtn.textContent = 'Mohon Sekarang';
    } else {
        PersonalLoanPages.textContent = 'Personal Loan';
        PersonalLoanPagesDes.textContent = 'With our personal loan, you will receive a personalised plan based on your credit worthiness and income, so your monthly repayments are well within budget, without overburdening your finance';
