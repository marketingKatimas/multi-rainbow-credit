...
//The Header
const PaydayLoanHeader = document.getElementById('PaydayLoanHeader');
const HomeHeader = document.getElementById('HomeHeader');
const PaydayLoanHeaderLink = document.getElementById('PaydayLoanHeaderLink');

//Payday Loan
const PaydayLoanPages = document.getElementById('PaydayLoanPages');
const PaydayLoanPagesDes = document.getElementById('PaydayLoanPagesDes');
...
function updateHeader(language) {
    if (language === 'bm') {
        PaydayLoanHeader.textContent = 'Pembiayaan Hari Gaji';
        HomeHeader.textContent = 'Laman Utama';
        PaydayLoanHeaderLink.textContent = 'Pembiayaan Hari Gaji';
    } else {
        PaydayLoanHeader.textContent = 'Payday Loan';
        HomeHeader.textContent = 'Home';
        PaydayLoanHeaderLink.textContent = 'Payday Loan';
    }
}

function updatePaydayLoan(language) {
    if (language === 'bm') {
        PaydayLoanPages.textContent = 'Pembiayaan Hari Gaji';
        PaydayLoanPagesDes.textContent = 'Bagi situasi tidak diduga, pembiayaan hari gaji diwujudkan untuk memberi anda bantuan kewangan segera. Tangani situasi mencabar dengan pembiayaan pantas dan selamat sehingga hari gaji seterusnya.';
        ApplyNowBtn.textContent = 'Mohon Sekarang';
    } else {
        PaydayLoanPages.textContent = 'Payday Loan';
        PaydayLoanPagesDes.textContent = 'For unexpected situations, our payday loans exist to provide instant financial relief that you need. Navigate through challenging situations with fast and accessible loans until your next paycheck.';
