...
//The Header
const MedicalLoanHeader = document.getElementById('MedicalLoanHeader');
const HomeHeader = document.getElementById('HomeHeader');
const MedicalLoanHeaderLink = document.getElementById('MedicalLoanHeaderLink');

//Medical Loan
const MedicalLoanPages = document.getElementById('MedicalLoanPages');
const MedicalLoanPagesDes = document.getElementById('MedicalLoanPagesDes');
...
function updateHeader(language) {
    if (language === 'bm') {
        MedicalLoanHeader.textContent = 'Pembiayaan Perubatan';
        HomeHeader.textContent = 'Laman Utama';
        MedicalLoanHeaderLink.textContent = 'Pembiayaan Perubatan';
    } else {
        MedicalLoanHeader.textContent = 'Medical Loan';
        HomeHeader.textContent = 'Home';
        MedicalLoanHeaderLink.textContent = 'Medical Loan';
    }
}

function updateMedicalLoan(language) {
    if (language === 'bm') {
        MedicalLoanPages.textContent = 'Pembiayaan Perubatan';
        MedicalLoanPagesDes.textContent = 'Kesihatan anda keutamaan kami. Dengan pembiayaan perubatan kami, dapatkan sokongan yang anda perlukan. Tumpukan kebajikan diri anda dengan pilihan bayaran balik kami yang fleksibel dan proses kelulusan yang pantas.';
        ApplyNowBtn.textContent = 'Mohon Sekarang';
    } else {
        MedicalLoanPages.textContent = 'Medical Loan';
        MedicalLoanPagesDes.textContent = 'Your health is our priority, and with our medical loan, you can receive the support you need. Focus on your well-being with our flexible repayment options and quick approval process.';
